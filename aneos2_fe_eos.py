...
rhot_data = np.load('eos/aneos/aneos_fe_rhot.npz')
...
logpvals_grid_rhot = rhot_data['logpvals'] # in dyn/cm2
s_grid_rhot = rhot_data['svals'] # in erg/g/K
logu_grid_rhot = rhot_data['loguvals'] # in erg/g
...
p_rgi_rhot = RGI((logtvals_rhot, logrhovals_rhot), logpvals_grid_rhot, method='linear', \
            bounds_error=False, fill_value=None)

u_rgi_rhot = RGI((logtvals_rhot, logrhovals_rhot), logu_grid_rhot, method='linear', \
            bounds_error=False, fill_value=None)
